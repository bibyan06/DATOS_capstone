...
<head>
    ...
    <title>Dean Upload Document</title>
...
<div id="main-content">
    <div class="sidebar" id="sidebar">
        <ul>
            <li><a href="{{ route('home.dean') }}"><i class="bi bi-house-fill" id="home-icon"></i> Home</a></li>
            <li><a href="{{ route('dean.dean_dashboard') }}"><i class="bi bi-grid-1x2-fill"></i> Dashboard</a></li>
            <li>
                ...
                <a href="{{route ('dean.dean_upload_document')}}"><i class="bi bi-upload"></i> Upload Document</a>
            </li>
        </ul>
        <div class="settings">
            <ul>
                <li><a href="{{ route('dean.dean_account') }}"><i class="bi bi-person-circle" id="account-icon"></i> Account</a></li>
