...
<head>
    ...
    <link rel="stylesheet" href="{{ asset ('css/os/all_docs.css') }}">
...
<body>
    ...
    <div class="extra-sidebar" id="home">
        <div class="sidebar-content">
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul class="more-dropdown-menu">
                        <li><a href="staff_memorandum.html" id="memorandum"> Memorandum</a></li>
                        <li><a href="staff_admin_orders.html" id="admin_order">Administrative Order</a></li>
                        <li><a href="staff_mrsp.html"idmrsp> Monthly Report Service Personnel</a></li>
            ...
            <ul>
                <li><a href="staff_notification.html" id="announcements-icon"> Notifications</a></li>
                <li><a href="staff_upload.html" id="upload">Upload</a></li>
            ...
            <div class="profile-content">
                <ul>
                    ...
                    <li><a href="staff_account.html" id="account">Profile</a></li>
                </ul>
        </div>
